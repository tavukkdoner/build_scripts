...
git clone https://github.com/tavukkdoner/local_manifests.git --depth 1 -b a15-matrixx .repo/local_manifests
...
export MATRIXX_CHIPSET=SDM439
export MATRIXX_BATTERY=4000mAh
export MATRIXX_DISPLAY=1440x720
